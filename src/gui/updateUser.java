...
String fname = "", lname="",username="",email="",city="",password="";
    ...
    public void setdata(Object id,Object fn,Object ln,Object em,Object phn, Object cty,Object pass,Object usr)
    {
        userid=(Integer)id;
        fname=fn.toString();
        lname=ln.toString();
        email=em.toString();
        phoneno=Long.parseLong(phn.toString());
        city=cty.toString();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Update User", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
        ...
        jPanel1.add(juserid, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 60, -1));
    ...
    private void jupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jupdateActionPerformed
        ...
        try{
            ...
            String query = "update registered_passengers set fName = '"+jfname.getText()+"',lName= '"+jlname.getText()+"',"
            + " email = '"+jemail.getText()+"',phoneNo='"+jphoneno.getText()+"',"
            + " city = '"+jcity.getText()+"', password='"+jpassword.getText()+"',"
            + "username='"+jusrname.getText()+"' where userId='"+juserid.getText()+"'";
